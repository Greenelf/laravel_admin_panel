...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('packages/greenelf/panel/favicon.ico')}}" type="image/x-icon">
    <link rel="icon" href="{{asset('packages/greenelf/panel/favicon.ico')}}" type="image/x-icon">
    ...
    <!--link media="all" type="text/css" rel="stylesheet" href="{{asset("packages/greenelf/rapyd-laravel/assets/colorpicker/css/bootstrap-colorpicker.min.css")}}" -->
...
<body class="@yield('bodyClass')">
    ...
    <script src="{{asset("packages/greenelf/panel/js/bootstrap.min.js")}}"></script>

    <!-- Custom Theme JavaScript -->
    <script src="{{asset("packages/greenelf/panel/js/sb-admin-2.js")}}"></script>
    ...
    <!--script src="{{asset("packages/greenelf/rapyd-laravel/assets/colorpicker/js/bootstrap-colorpicker.min.js")}}"></script-->
